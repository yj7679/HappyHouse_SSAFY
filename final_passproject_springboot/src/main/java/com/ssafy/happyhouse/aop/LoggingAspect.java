...
public class LoggingAspect {
	...
	@Around(value = "execution(* com.ssafy.happyhouse.model..Member*.insetMember*(..))")
	...
	@AfterReturning(value = "execution(* com.ssafy.happyhouse.model..GuestBook*.insetMember*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.happyhouse.model..Member*.insetMember*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.happyhouse.model..Member*.list*(..))")
